...
//!
//! Fonctions :
//! - fn `design_css` — retourne le CSS complet (`assets/styles.css`), source unique de vérité pour tokens de design, classes de composants, primitives de layout et overrides webkit2gtk
