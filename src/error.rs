...
//!
//! Fonctions :
//! - enum `J2sError` — type d'erreur central du crate (I/O, parsing JSON, DB, schéma, anomalies).
//! - fn `J2sError::from` — implémente `From<serde_json::Error>`, capture la position (colonne) de l'erreur de parsing.
use thiserror::Error;
