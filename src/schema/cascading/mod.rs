...
//!
//! Ce module contient : scoring (Jaccard, compatibilité enfants), détection des groupes,
//! construction des `TableSchema` fusionnés, et le traitement des co-siblings.

pub mod scoring;
pub use scoring::{child_compatibility_score, pairwise_jaccard_min};
use scoring::{greedy_schema_clusters, pg_truncate_name, siblings_key_prefix, unique_cluster_suffix};
